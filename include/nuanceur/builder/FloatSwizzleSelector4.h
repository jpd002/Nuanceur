...
namespace Nuanceur
{
	...
	public:
		...
		CFloat4Rvalue yzwx() const
		{
			return CFloat4Rvalue(m_symbol, SWIZZLE_YZWX);
		}

		CFloat4Rvalue wxyz() const
		{
			return CFloat4Rvalue(m_symbol, SWIZZLE_WXYZ);
		}

		CFloat4Rvalue wzyx() const
		{
			return CFloat4Rvalue(m_symbol, SWIZZLE_WZYX);
		}

...
GENERATE_VECTOR_BINARY_INT_OP(STATEMENT_OP_ADD, +, CInt4)
...
GENERATE_VECTOR_BINARY_INT_OP(STATEMENT_OP_SUBSTRACT, -, CInt4)
...
GENERATE_VECTOR_BINARY_INT_OP(STATEMENT_OP_DIVIDE, /, CInt2)
GENERATE_VECTOR_BINARY_INT_OP(STATEMENT_OP_DIVIDE, /, CInt4)

GENERATE_VECTOR_BINARY_INT_OP(STATEMENT_OP_MODULO, %, CInt)

GENERATE_VECTOR_BINARY_INT_OP(STATEMENT_OP_LSHIFT, <<, CInt)
GENERATE_VECTOR_BINARY_INT_OP(STATEMENT_OP_LSHIFT, <<, CInt2)
...
GENERATE_VECTOR_COMPARE_OP(STATEMENT_OP_COMPARE_NE, !=, CFloat)
...
CFloat4Rvalue Nuanceur::Load(const CArrayFloat4Value& buffer, const CIntValue& index)
{
